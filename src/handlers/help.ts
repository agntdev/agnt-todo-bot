...
const HELP =
  "TodoFlow keeps personal and shared tasks together.\n\n" +
  "Tap /start to open the menu. Add tasks, set due dates, share a list, and check its activity without memorising commands.";
